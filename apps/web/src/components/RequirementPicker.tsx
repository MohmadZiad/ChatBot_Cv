...
export type ReqItem = { requirement: string; mustHave: boolean; weight: number };

const IT_WORDS = [
  "React","Next.js","TypeScript","JavaScript","Node.js","Express","NestJS","GraphQL","REST",
  "Tailwind CSS","Sass","CSS3","HTML5","Vite","Webpack","Babel",
  "Redux","Zustand","TanStack Query","RxJS",
  "Jest","Vitest","Playwright","Cypress","Testing Library",
  "MongoDB","PostgreSQL","MySQL","SQLite","Prisma","TypeORM","Drizzle",
  "Redis","ElasticSearch","Kafka","RabbitMQ",
  "AWS","GCP","Azure","Cloudflare","Vercel","Netlify","Docker","Kubernetes","Terraform",
  "CI/CD","GitHub Actions","GitLab CI","CircleCI",
  "Authentication","OAuth2","JWT","SAML","OpenID Connect",
  "Security","OWASP","ZAP","Snyk","SonarQube",
  "WebSockets","Socket.io","gRPC","tRPC",
  "Microservices","Event-driven","DDD","Clean Architecture","SOLID",
  "Performance","Caching","CDN","SSR","SSG","ISR",
  "i18n","RTL","Accessibility","SEO","Analytics",
  "Python","Django","Flask","FastAPI",
  "Go","Rust","C#",".NET","Java","Spring Boot","Kotlin",
  "Agile","Scrum","Kanban","Jira","Confluence",
  "AI","LLM","Prompt Engineering","RAG","Embeddings","Vector DB","pgvector",
  "OpenAI API","LangChain","Whisper","Vision",
  "Mobile","React Native","Expo","PWA",
  "Design Systems","Storybook","Figma","Shadcn UI","Radix UI",
  "Logging","Observability","OpenTelemetry","Sentry","Datadog"
];
...
export default function RequirementPicker({ onAdd }: Props) {
  ...
  const list = useMemo(() => {
    ...
    return s ? IT_WORDS.filter(w => w.toLowerCase().includes(s)) : IT_WORDS.slice(0, 20);
  }, [q]);
