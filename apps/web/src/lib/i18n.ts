...
export const dict = {
  ar: {
    ...
    chat: {
      ...
      mustTag: "أساسي",
      weightLabel: "وزن",
      suggestedTitle: "مجموعة المتطلبات المقترحة",
      applySuggested: "أضف إلى خانة المتطلبات",
      copySuggested: "انسخ القائمة",
      saveJob: "حفظ كوظيفة",
      jobSaved: "تم حفظ الوظيفة وإضافتها للخيارات.",
      saveJobError: "تأكد من وجود عنوان مناسب للوظيفة قبل الحفظ.",
    ...
    analysisPage: {
      ...
      noBreakdown: "لا تتوفر تفاصيل للمتطلبات حالياً.",
      noStrengths: "لم يتم رصد نقاط قوة بارزة بعد.",
      gaps: "الفجوات",
      noGaps: "لا توجد فجوات أساسية",
      rowsLabel: "إجمالي العناصر:",
      must: "أساسي",
      nice: "تكميلي",
      emptyBreakdown: "لا تتوفر تفاصيل للمتطلبات حتى الآن.",
      risks: "المخاطر",
      noRisks: "لا توجد مخاطر مسجّلة.",
    },
  },
  en: {
    app: "CV Matcher",
    chat: {
      ...
      mustTag: "Must",
      weightLabel: "Weight",
      suggestedTitle: "Suggested set",
      applySuggested: "Add to requirements",
      copySuggested: "Copy list",
      saveJob: "Save as job",
      jobSaved: "Job saved and ready to select.",
      saveJobError: "Please include a clear title before saving the job.",
    ...
    analysisPage: {
      ...
      noBreakdown: "No requirement details are available yet.",
      noStrengths: "No standout strengths detected yet.",
      gaps: "Gaps",
